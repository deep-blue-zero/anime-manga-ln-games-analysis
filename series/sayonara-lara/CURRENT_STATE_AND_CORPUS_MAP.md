...
created: "2026-09-20"
source_boundary: "Japanese-language TV anime E01-E11 closed at Japanese-caption and complete static-visual scope; E04/E08 checkpoints complete; E12 inventoried"
...
| Source register and execution record | E01-E11 inspection recorded; E12 inventory locked |
| Six longitudinal ledgers | Synchronized through E11 |
| Legacy register | Historical/legacy and non-evidentiary |
| Sequential readings | E01-E11 complete for declared Japanese-text/static-visual scope; [E04](02_Episode_Readings/SYL_E04_CHECKPOINT.md) and [E08](02_Episode_Readings/SYL_E08_CHECKPOINT.md) checkpoints passed; E12 next |
...
These debts do not authorize invented observations and do not block text/static narrative reconstruction where the supplied evidence is adequate. They do block unqualified final claims in their affected channels. E01-E11 assign claim-linked intervals and actions to `SYL-D0001`-`SYL-D0003` in their readings and the debt register.

## Latest closed transaction

[Episode 11: Grace's Dream, the Law, and the Mirror](02_Episode_Readings/SYL_EP11_DEEP_READING.md) stages the prior Grace/Rigmor twin dream, Rigmor/Rowan's productive light, human rejection and a contested death, and Rowan's creation of the ban. Grace's revival of Lara and suspension of the court are revealed; *young* Mari's historical care for fish-form Grace explains their household tie and challenges categorical anti-human despair. Grace's fate after E10, exact injury and final light mechanisms remain open.

## Next operation

After committing the closed E11 transaction, open E12 from the locked source bundle, read the complete aligned Japanese witness, inspect all E12 contact sheets and necessary full-resolution frames, build the analyst scene map, synchronize ledgers and debts, validate, and commit before final synthesis-readiness review.
