...
created: "2026-09-19"
source_boundary: "Japanese manga witnesses RAG-JP-EPUB-V001-V014; inspected and closed through V014; checkpointed and locally audited through V010."
---
...
|---|---|---|---|---|---|---|
| RAG-LOCAL-KAZUYA | Kazuya Kinoshita; 木ノ下和也 | RAG-E-V001-001 | `04 Character Analysis/Kazuya Kinoshita/RAG_KAZUYA_EVIDENCE_LEDGER.md`; `RAG_KAZUYA_RECONSTRUCTION_MODEL.md`; no monograph | Observed through V014: campaign traction and stall, large-scale source search, rights outreach, repeated director recruitment, acceptance of analytics and team strategy, direct promotional spending, and persistence through public rejection, in addition to prior relational and support evidence. Missing: broad ordinary routine, durable honesty across audiences, completed funding and production competence, Chizuru's response to direct preference information, acknowledged reciprocal partnership. | OPERATIONAL_CANDIDATE | V014 volume update |
| RAG-LOCAL-CHIZURU | Chizuru Ichinose; rental alias Chizuru Mizuhara / 水原千鶴; campus surname Ichinose / 一ノ瀬 | RAG-E-V001-002 | `04 Character Analysis/Chizuru Ichinose/RAG_CHIZURU_EVIDENCE_LEDGER.md`; `RAG_CHIZURU_RECONSTRUCTION_MODEL.md`; no monograph | Observed through V014: source approval, director contact, campaign-recovery participation, personal-item reward contribution, intimate-boundary enforcement, gratitude classification, and receipt of Mini's direct preference claim, in addition to prior professional and family evidence. Missing: sustained ordinary routine, completed career or film outcome, broad interior access, response to the disclosure, and romantic self-report. | OPERATIONAL_CANDIDATE | V014 volume update |
...
| RAG-LOCAL-MINI | Mini Yaemori; 八重森みに | RAG-E-V013-012 | none | Observed through V014 as a university junior, cosplayer, streamer, online creator, crowdfunding participant, campaign analyst, meeting convener, strategy designer, reward coordinator, and forceful romantic intermediary. Missing: broader history, long-term reliability, limits on disclosure, and independent goals beyond creator work and support for Kazuya. | EVIDENCE_LEDGER_ELIGIBLE | V014 |
...
| RAG-LOCAL-RUKA | Ruka Sarashina; 更科るか | RAG-E-V003-012 | `04 Character Analysis/Ruka Sarashina/RAG_RUKA_EVIDENCE_LEDGER.md`; `RAG_RUKA_RECONSTRUCTION_MODEL.md`; no monograph | Observed through V014: prior provider recognition, secrecy leverage, low-pulse self-monitoring, trial dating, rivalry, sexual pressure, refusal, unilateral kisses, public overstatement, local apology, crisis truce, and now unpriced team and flyer labor for Chizuru's film when Kazuya's burden is visible. Missing: sustained ordinary routine, exact medical diagnosis, broader relationships, response to a definitive end of the trial, and durable cooperation under renewed rivalry. | PARTIAL_MODEL | V014 volume update |
...
| RAG-LOCAL-SUMI | Sumi Sakurasawa; 桜沢墨 | RAG-E-V005-014 | none | Observed as a first-year university student and new rental girlfriend referred by Chizuru for practice; severe communication difficulty coexists with determined effort, adaptive learning, protective role performance, hero-show work, completed birthday-gift guidance, preference inference from a chance sighting, school-uniform initiative, a completed aquarium itinerary, practical bodily care, gift giving, an unheard love confession, precise written inquiry, grief sharing, and consequential emotional support. Missing: fuller history, stable independent provider competence, broad spontaneous speech, and Kazuya's reception of her romantic feeling. | EVIDENCE_LEDGER_ELIGIBLE | V012 |
