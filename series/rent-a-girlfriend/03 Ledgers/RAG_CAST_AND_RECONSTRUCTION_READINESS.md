...
| RAG-LOCAL-SUMI | Sumi Sakurasawa; 桜沢墨 | RAG-E-V005-014 | none | Observed as a first-year university student and new rental girlfriend referred by Chizuru for practice; severe communication difficulty coexists with determined effort, adaptive learning, protective role performance, a successful smile, continued work, advice-seeking, and concern about emerging personal feeling. Missing: fuller history, stable independent provider competence, and durable behavior beyond the supplemental V007 vignette. | EVIDENCE_LEDGER_ELIGIBLE | V007 |
