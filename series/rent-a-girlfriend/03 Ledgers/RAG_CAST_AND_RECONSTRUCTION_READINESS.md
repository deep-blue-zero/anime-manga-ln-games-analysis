...
| RAG-LOCAL-SUMI | Sumi Sakurasawa; 桜沢墨 | RAG-E-V005-014 | none | Observed as a first-year university student and new rental girlfriend referred by Chizuru for practice; severe communication difficulty coexists with determined effort, adaptive learning, protective role performance, continued work, and increasingly active birthday-gift guidance through speech, writing, gesture, choices, and initiated contact. Missing: fuller history, stable independent provider competence, and the conclusion of the V008 help date. | EVIDENCE_LEDGER_ELIGIBLE | V008 |
