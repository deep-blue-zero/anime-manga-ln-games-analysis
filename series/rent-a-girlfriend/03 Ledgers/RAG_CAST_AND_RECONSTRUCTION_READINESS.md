...
created: "2026-09-19"
source_boundary: "Japanese manga witnesses RAG-JP-EPUB-V001-V015; inspected and closed through V015; checkpointed and locally audited through V010."
---
...
|---|---|---|---|---|---|---|
| RAG-LOCAL-KAZUYA | Kazuya Kinoshita; 木ノ下和也 | RAG-E-V001-001 | `04 Character Analysis/Kazuya Kinoshita/RAG_KAZUYA_EVIDENCE_LEDGER.md`; `RAG_KAZUYA_RECONSTRUCTION_MODEL.md`; no monograph | Observed through V015: funded campaign transition, producer introduction, logistics under Tabuse, respect for an on-set concentration boundary, unsafe removal of a sound bottleneck, and explicit future-distance anxiety, in addition to prior relational and support evidence. Missing: broad ordinary routine, durable honesty across audiences, safe long-term production judgment, completed film delivery, and acknowledged reciprocal partnership. | OPERATIONAL_CANDIDATE | V015 volume update |
| RAG-LOCAL-CHIZURU | Chizuru Ichinose; rental alias Chizuru Mizuhara / 水原千鶴; campus surname Ichinose / 一ノ瀬 | RAG-E-V001-002 | `04 Character Analysis/Chizuru Ichinose/RAG_CHIZURU_EVIDENCE_LEDGER.md`; `RAG_CHIZURU_RECONSTRUCTION_MODEL.md`; no monograph | Observed through V015: response to Mini's disclosure, professional-network initiative, direct credit to Kazuya, dinner refusal, qualified non-negation, on-set access control, script preparation, and a locally moving filmed take, in addition to prior professional and family evidence. Missing: sustained ordinary routine, completed career or film outcome, broad interior access, direct mutual discussion, and affirmative romantic classification. | OPERATIONAL_CANDIDATE | V015 volume update |
...
| RAG-LOCAL-MINI | Mini Yaemori; 八重森みに | RAG-E-V013-012 | none | Observed through V015 as a university junior, cosplayer, streamer, online creator, crowdfunding participant, campaign analyst, meeting convener, strategy designer, reward coordinator, and forceful romantic intermediary whose unauthorized disclosure produces direct consequences. Missing: broader history, long-term reliability, limits on disclosure, and independent goals beyond creator work and support for Kazuya. | EVIDENCE_LEDGER_ELIGIBLE | V015 |
...
| RAG-LOCAL-RUKA | Ruka Sarashina; 更科るか | RAG-E-V003-012 | `04 Character Analysis/Ruka Sarashina/RAG_RUKA_EVIDENCE_LEDGER.md`; `RAG_RUKA_RECONSTRUCTION_MODEL.md`; no monograph | Observed through V015: prior provider recognition, secrecy leverage, low-pulse self-monitoring, trial dating, rivalry, sexual pressure, refusal, unilateral kisses, public overstatement, local apology, crisis truce, and repeated project-first labor that persists under an immediate Umi rivalry cue. Missing: sustained ordinary routine, exact medical diagnosis, broader relationships, response to a definitive end of the trial, and post-funding cooperation. | PARTIAL_MODEL | V015 volume update |
