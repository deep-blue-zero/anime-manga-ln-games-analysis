...
created: "2026-09-19"
source_boundary: "Japanese manga witnesses RAG-JP-EPUB-V001-V019; inspected and closed through V019; checkpointed and locally audited through V010."
---
...
|---|---|---|---|---|---|---|
| RAG-LOCAL-KAZUYA | Kazuya Kinoshita; 木ノ下和也 | RAG-E-V001-001 | `04 Character Analysis/Kazuya Kinoshita/RAG_KAZUYA_EVIDENCE_LEDGER.md`; `RAG_KAZUYA_RECONSTRUCTION_MODEL.md`; no monograph | Observed through V019: completion of the funded ten-hour date, tailored activity, recognition that restored brightness is a grief wall, a permission-bearing ideal-girlfriend speech, reception of Chizuru's self-initiated collapse, and explicit internal acknowledgment of love, in addition to prior production and relational evidence. Missing: broad ordinary routine, durable honesty across audiences, safe long-term production judgment, completed public exhibition, knowledge of Chizuru's later relief report, fair resolution of the Ruka trial, and acknowledged reciprocal partnership. | OPERATIONAL_CANDIDATE | V019 volume update |
| RAG-LOCAL-CHIZURU | Chizuru Ichinose; rental alias Chizuru Mizuhara / 水原千鶴; campus surname Ichinose / 一ノ瀬 | RAG-E-V001-002 | `04 Character Analysis/Chizuru Ichinose/RAG_CHIZURU_EVIDENCE_LEDGER.md`; `RAG_CHIZURU_RECONSTRUCTION_MODEL.md`; no monograph | Observed through V019: acceptance and active shaping of the ten-hour booking, direct recognition of its care purpose, gratitude without debt, real activity enjoyment, family-memory triggers, self-initiated bodily grief support, and a direct report to Mini of severe loneliness and relief while retaining the non-boyfriend classification. Missing: completed public exhibition, sustained bereavement course, direct discussion with Kazuya of the crying episode, mutual romantic discussion, and final shared relationship classification. | OPERATIONAL_CANDIDATE | V019 volume update |
...
| RAG-LOCAL-MINI | Mini Yaemori; 八重森みに | RAG-E-V013-012 | none | Observed through V019 as a university junior, creator, campaign analyst, forceful romantic intermediary, architect of a two-person trip through false absence information, and now direct questioner who elicits Chizuru's non-boyfriend classification and report of grief relief after Kazuya withholds details. Missing: broader history, long-term reliability, later use of the disclosure, limits on pressure and manipulation, and independent goals beyond creator work and support for Kazuya. | EVIDENCE_LEDGER_ELIGIBLE | V019 volume update |
...
| RAG-LOCAL-RUKA | Ruka Sarashina; 更科るか | RAG-E-V003-012 | `04 Character Analysis/Ruka Sarashina/RAG_RUKA_EVIDENCE_LEDGER.md`; `RAG_RUKA_RECONSTRUCTION_MODEL.md`; no monograph | Observed through V018: her broad touch request narrows to consensual sunscreen, a blocked hug becomes first-name permission and public status pressure, and she later responds sympathetically to Chizuru's bereavement while permitting Kazuya's immediate support route and preserving a future amusement-park request. V019 supplies no appearance or consequence to that request. Missing: sustained ordinary routine, exact medical diagnosis, broader relationships, response to a definitive end of the trial, and durable conduct after tactical accommodation. | PARTIAL_MODEL | V019 negative-evidence review |
