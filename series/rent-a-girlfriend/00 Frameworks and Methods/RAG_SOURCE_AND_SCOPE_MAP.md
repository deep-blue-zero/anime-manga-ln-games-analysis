...
source_boundary: "Owner-authorized Japanese collected-volume EPUB witnesses V001-V047; V001-V021 inspected and closed; V021-V030 admitted in order, with V022 structurally verified and open."
---
...
| V022 | RAG-JP-EPUB-V022 | 117566247 | `21b4d7b192bf3c42b83ec9a6a5d4ec58f04e095b65e568555f6ef75975e4030c` | 彼女、お借りします（２２） | `ja` | 237 | 238 | VERIFIED__ACTIVE_RUN_OPEN |
...
- Structural verification of V022 confirms the inventoried SHA-256, a passing ZIP CRC check, rootfile `OPS/standard.opf`, and a continuous 237-entry spine resolving once each to `OPS/images/0001.jpg`-`0237.jpg`. The sole manifest image outside that sequence is `OPS/OPS/cover.jpg`. Direct visible-language confirmation, page classification, and narrative inspection remain pending under the committed entering freeze.
...
V001-V021 are inspected and closed; V001-V020 are also checkpointed and locally audited. V021-V030 remain admitted in order for the active run; V022 is structurally verified and open under its entering freeze. V031-V047 remain filename- and metadata-visible only, and their narrative pages, previews, chapter labels, and story-bearing paratext are not admitted.
