---
title: "Rent-a-Girlfriend - Kibe Evidence Ledger"
artifact_id: RAG_KIBE_EVIDENCE_LEDGER
...
created: "2026-09-20"
source_boundary: "Japanese manga witnesses RAG-JP-EPUB-V001-V025; character evidence inspected through V025, with no material V024 conduct."
---
...
This ledger owns Kibe's project-local evidence trace as Kazuya's childhood friend, peer-group moral intervener, information-limited supporter, and V020 intermediary. His given name is not established in the admitted witnesses.

~~~yaml
local_character_key: RAG-LOCAL-KIBE
preferred_name: Kibe
verified_name_form: 木部
given_name: null
...
|---|---|---|---|---|---|---|---|
| RAG-KIB-E001 | KIB-S001 | RAG-E-V001-011 | Peer gathering; social audience | Appears inside the university friend group before the relationship account is corrected. | Participates in the audience that receives Kazuya and Chizuru as a couple. | The entry supplies little independent conduct. | none; model withheld |
| RAG-KIB-E002 | KIB-S001 | RAG-E-V002-004 | Trip encounter; peer-network collision | Meets the apparent couple on the Izu trip and carries prior friendship expectations into the shared audience. | Treats the relationship presentation as real. | His later judgments remain conditioned by false information. | none; model withheld |
| RAG-KIB-E003 | KIB-S002 | RAG-E-V002-012 | Physical confrontation and moral speech; friendship | Punches Kazuya after the announced breakup and condemns what he understands as mistreatment of Chizuru. | Uses force and direct judgment to defend the perceived injured party. | Violence is not justified by the false premise or by protective intent. | none; model withheld |
| RAG-KIB-E004 | KIB-S002 | RAG-E-V002-014 | Childhood testimony and resource transfer; support | Describes Kazuya's persistence through a morning-glory story and gives the pair ferry tickets. | Converts an affectionate childhood model into a practical reconciliation opportunity. | His positive model does not include the rental truth or Chizuru's consent to romance. | none; model withheld |
| RAG-KIB-E005 | KIB-S002 | RAG-E-V002-015 | Logistical follow-through; couple access | Produces the ferry ride that follows his intervention. | Acts beyond advice by supplying time and place. | The later overboard crisis is not an intended consequence. | none; model withheld |
| RAG-KIB-E006 | KIB-S003 | RAG-E-V003-004 | Rescue interpretation and secrecy request; friendship | Reads Kazuya's rescue as meaningful, directs him toward Chizuru, and asks that the event be hidden from Nagomi. | Uses partial knowledge to advocate for the apparent relationship while controlling one family disclosure. | Rescue does not establish mutual romance, and he still lacks the rental history. | none; model withheld |
| RAG-KIB-E007 | KIB-S003 | RAG-E-V005-011 | Negative information boundary; friendship | Remains outside Kazuya's targeted disclosure to Kuribayashi. | No new conduct occurs, but the information asymmetry is consequential to later judgments. | Absence from a disclosure is not evidence of how he would respond to it. | none; information limit only |
...
| RAG-KIB-E016 | KIB-S008 | RAG-E-V025-021, RAG-E-V025-022 | Direct rental-profile exposure before an uninformed peer | Is present and reacts when Nagomi's fallen phone displays Chizuru's Diamond profile to the group. | Gains direct evidence that the woman he understood as Kazuya's genuine girlfriend is listed as a rental provider. | The volume cuts before his interpretation, question, blame, or integration with Ruka's earlier contradictory claim. | none; information limit only |

## State-change summary

- KIB-S001 — information-limited peer witness: knows Kazuya's history and accepts the presented girlfriend account.
...
- KIB-S008 — newly exposed but not yet calibrated peer: directly encounters Chizuru's Diamond profile on Nagomi's phone after years of treating the couple as genuine, with no admitted explanation or response beyond immediate reaction.

## Written-speech and ordinary-conduct notes

- Kibe can move quickly from moral judgment to direct physical or logistical intervention.
...
- Kibe sees direct rental-profile evidence in V025 but has not been observed receiving the complete rental, provisional-relationship, and deception history.
...
Append only when later authorized evidence materially changes Kibe's information state, independent routine, friendship practice, or intermediary role. A model remains withheld until repeated behavior under corrected facts and more than one relationship domain becomes available.
