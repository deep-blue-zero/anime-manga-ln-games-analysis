...
## Extended source reverification and bounded propagation

The checks below add actual continuation inspections to SR01–SR02. The same CBZ SHA-256 locks above apply. A contact sheet or extracted image counts here only when it was opened and visually examined; extraction alone is not inspection. Existing V2 evidence and the supplied prior-session direct reviews remain usable with that provenance. In particular the inherited V10 and V40 findings and the earlier complete V42 narrative review are not relabeled as new complete rereads.

| Check | Additional pages actually inspected | Decisive finding / exclusion |
|---|---|---|
| SR03 — Nighteye and Mirio | V18:p038,p072,p074–077,p088–090 | Nighteye's differing future is an observation; converging energy is his hypothesis, not verified physics. Mirio refuses the offered hypothetical transfer and conditions later help on safe Eri control. Ethical credibility does not resolve later OFA bodily compatibility. |
| SR04 — OFA compatibility and V31 tail | V31:p164–169,p171–174,p212–214,p225 | Hikage's case, All Might's Quirklessness and accumulated burden qualify successor suitability. Raw +1 mapping is confirmed. Logical p213/raw 0214 is final narrative; p214/raw 0215 begins non-sequential tail and p225/raw 0226 is digital cover matter. The old logical p214–226 tail is repaired to p214–225 without altering chapter starts. |
| SR05 — fear, causation, Big Three attribution | V36:p078,p082,p084,p087,p089,p091–092,p163,p170–171,p173–181 | Jiro's empathy and the multicausal AFO disruption are distinct. Mirio speaks an apology at p170, reconsiders at p171. Team preparation p173–179 does not assign every speech bubble to Tamaki; p180 is author promotion, p181 his received-belief reflection. Facing-page formula verified. |
| SR06 — Shoji paratext | V37:p140,p142,p148 | Valid anti-revenge/classmate voice and childhood rescue memory at p140,p142. p148 explicitly presents an author-shared Twitter kimono drawing. Excluded from behavioral reconstruction; readiness stays strong on other evidence. |
| SR07 — rehabilitation, cost and audience | V38:p054,p057–059,p062–068,p081–083 | Gentle prevents a prison escape and rescues U.A.; joy precedes camera discovery, not a permanently unseen performance. p062 recap/p063 cover/p064 logo are excluded as behavior. Nagant p065–068 contains medical objection, reopened wounds and chosen aid. |
| SR08 — observer and actor | V39:p146,p154–155 | Tsukauchi's interpretation of dangerous action is not All Might's transparent motive. All Might explicitly states win-directed intent; bonds and equipment enable action without guaranteeing success. |
| SR09 — agency, children and speakers | V41:p110,p116,p121,p123,p132,p157–159,p168,p175 | Nana's blocking; Tenko's contradiction and League intent; AFO's attributed engineering claim; Eri's limited aid plus adult concern; Sero against necessary suffering; Aoyama's mutual-need line. No total restoration, universal determinism or cost-free child resource follows. |
| SR10 — ending distinctions | V42:p009–011,p014–015,p018,p042–043,p062–064,p118–119,p132,p134,p140–141,p144–145,p149–151,p153,p159,p167–168,p180–183 | Mixed Kurogiri continuity, AFO's possessive need, Mirio's positive-future claim, narrow Toya apology, institutional resources and civilian finite hands, Shoji's work, chosen teaching/support, adult Tamaki's care/correction, Toya altar, ordinary desires and mutual approach. Both p144 and p145 are authorial afterword; their existing classification was confirmed, not corrected. |

### Propagation and inferential limits

Bounded current notices repair the primary locator, source inventory, readiness descriptions and affected cumulative ledgers. Historical volume records, ledger IDs, row order, prior tiers, chronology and frozen blobs remain intact. An adjacent correction explicitly invalidates the Class 1-A ledger's p148 kimono-behavior clause. The existing visual-motif ledger already excludes the relevant author matter and receives no manufactured repair.

The source correction does not create new blind predictions, upgrade readiness, infer every AFO internal event from Jiro's sound, attribute observer intent to All Might, convert a dream into objective survival, or turn an altar into a directly depicted death. V42:p167 makes Toya's death by the adult setting a **strong inference**; exact time, mechanism and final interaction remain unshown. Likewise, teaching even with retained OFA is Midoriya's explicit counterfactual at p159, not a claim that OFA was retained.

The new synthesis corpus cites primary locators alongside maintained ledger IDs or named volume/topic sections. The aggregate report owns cross-model limitations; each dossier retains its detailed probe transaction. The complete fourteen-ledger disposition was written before specialist drafting. Source verification supports analytical interpretation within V01–V42, including chapter 431, and does not complete the provisional supplemental inventory.
