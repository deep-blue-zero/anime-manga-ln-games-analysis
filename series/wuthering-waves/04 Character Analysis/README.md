---
series: WUWA
artifact_type: character_analysis_index
scope: CHARACTER_ANALYSIS
source_boundary: "Git-side character analysis; primary and derived evidence remains in Drive"
generation: V0.1
status: canonical
...
- `Chisa/` — twelve-document pre-AV rebuild V0.1; owner-adopted current `active_provisional` authority; audiovisual analysis pending.
