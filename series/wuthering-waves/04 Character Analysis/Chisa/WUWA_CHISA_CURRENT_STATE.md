...
scope: CHISA_SOURCE_3_6_0
source_boundary: "Pinned 3.6.0 semantic source and installed-client voice evidence routed through the Drive Chisa V0.1 bridge"
generation: V0.1
status: canonical
...
# Chisa — current analytical state
...
- 539 voiced story occurrences and 194 unvoiced occurrences;
- 68 archive/favor records;
- 607 semantic voice lines;
- 2,429 render associations/runtime objects;
- zero structured human acting annotations.
