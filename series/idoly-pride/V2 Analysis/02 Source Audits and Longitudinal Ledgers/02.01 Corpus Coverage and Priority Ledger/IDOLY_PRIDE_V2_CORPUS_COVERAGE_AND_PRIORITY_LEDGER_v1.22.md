...
version: "1.22-phase-1"
status: "phase-1-bond-reranked-working-ledger"
source_snapshot_id: "IP-V2-SNAPSHOT-2026-08-13-A"
source_cutoff: "2026-08-13"
created: "2026-08-13"
updated: "2026-08-16"
supersedes_working_version: "1.21-phase-1b"
...
| `bond_hrk_001_hrk` | Bond stories: hrk | `IMPORTANT` | `PHASE1_BOND_RERANKED_PENDING_CLOSE_READ` | — |  | 8 |
| `bond_kan_001_kan` | Bond stories: kan | `CORE` | `PHASE1_BOND_RERANKED_PENDING_CLOSE_READ` | — |  | 8 |
| `bond_kkr_001_kkr` | Bond stories: kkr | `SUPPORT` | `PHASE1_BOND_RERANKED_SUPPORT_MINING` | — |  | 8 |
| `bond_kor_001_kor` | Bond stories: kor | `CORE` | `PHASE1_BOND_RERANKED_PENDING_CLOSE_READ` | — |  | 8 |
| `bond_ktn_001_ktn` | Bond stories: ktn | `CORE` | `PHASE1_BOND_RERANKED_PENDING_CLOSE_READ` | — |  | 8 |
| `bond_mei_001_mei` | Bond stories: mei | `TEXTURE` | `PHASE1_BOND_RERANKED_TEXTURE_INDEXED` | — |  | 8 |
| `bond_mhk_001_mhk` | Bond stories: mhk | `IMPORTANT` | `PHASE1_BOND_RERANKED_PENDING_CLOSE_READ` | — |  | 8 |
| `bond_ngs_001_ngs` | Bond stories: ngs | `SUPPORT` | `PHASE1_BOND_RERANKED_SUPPORT_MINING` | — |  | 8 |
| `bond_rei_001_rei` | Bond stories: rei | `IMPORTANT` | `PHASE1_BOND_RERANKED_PENDING_CLOSE_READ` | — |  | 8 |
| `bond_rio_001_rio` | Bond stories: rio | `IMPORTANT` | `PHASE1_BOND_RERANKED_PENDING_CLOSE_READ` | — |  | 8 |
| `bond_rui_001_rui` | Bond stories: rui | `IMPORTANT` | `PHASE1_BOND_RERANKED_PENDING_CLOSE_READ` | — |  | 8 |
| `bond_ski_001_ski` | Bond stories: ski | `IMPORTANT` | `PHASE1_BOND_RERANKED_PENDING_CLOSE_READ` | — |  | 8 |
| `bond_skr_001_skr` | Bond stories: skr | `IMPORTANT` | `PHASE1_BOND_RERANKED_PENDING_CLOSE_READ` | — |  | 8 |
| `bond_smr_001_smr` | Bond stories: smr | `IMPORTANT` | `PHASE1_BOND_RERANKED_PENDING_CLOSE_READ` | — |  | 8 |
| `bond_suz_001_suz` | Bond stories: suz | `SUPPORT` | `PHASE1_BOND_RERANKED_SUPPORT_MINING` | — |  | 8 |
| `bond_szk_001_szk` | Bond stories: szk | `IMPORTANT` | `PHASE1_BOND_RERANKED_PENDING_CLOSE_READ` | — |  | 8 |
