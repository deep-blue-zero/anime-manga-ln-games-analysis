...
version: "1.12-phase-1b"
status: "phase-1b-post-e1-e2-reassessed-working-ledger"
source_snapshot_id: "IP-V2-SNAPSHOT-2026-08-13-A"
source_cutoff: "2026-08-13"
created: "2026-08-13"
updated: "2026-08-15"
supersedes_working_version: "1.11-phase-1b"
...
| `event_2021_003_st-eve-2109-backside` | 芽吹く黒ユリの蕾 | `IMPORTANT` | `POST_E1_REASSESSED_PENDING_CLOSE_READ` | IMPORTANT |  | 5 |
| `event_2021_004_st-eve-2110-marathon` | 煌めく奇跡をもう一度 | `CORE` | `PASS_B_EVENT_E1A_AUDITED` | IMPORTANT |  | 6 |
| `event_2021_005_st-eve-2111-backside` | 夢踊るステージに架け橋を | `IMPORTANT` | `POST_E1_REASSESSED_PENDING_CLOSE_READ` | IMPORTANT |  | 5 |
| `event_2021_006_st-eve-2112-marathon` | 羽休む聖夜のサプライズ | `IMPORTANT` | `POST_E1_REASSESSED_PENDING_CLOSE_READ` | IMPORTANT |  | 5 |
| `event_2022_001_st-eve-2201-contest` | 昇る初陽に咲く笑顔 | `SUPPORT` | `RERANKED_PENDING_CLOSE_READ` | IMPORTANT |  | 5 |
| `event_2022_002_st-eve-2202-marathon` | 心愛溶けるビターチョコレート | `IMPORTANT` | `POST_E1_REASSESSED_PENDING_CLOSE_READ` | IMPORTANT |  | 5 |
| `event_2022_003_st-eve-2203-race` | 並び立つ歌姫のフルリール | `IMPORTANT` | `POST_E1_REASSESSED_PENDING_CLOSE_READ` | IMPORTANT |  | 6 |
| `event_2022_004_st-eve-2204-contest` | 愛歌う星の継承者 | `SUPPORT` | `POST_E1_REASSESSED_SUPPORT_DEFERRED` | CORE |  | 6 |
| `event_2022_005_st-eve-2205-race` | 心紡ぎ合う輝きの競演 | `IMPORTANT` | `POST_E1_REASSESSED_PENDING_CLOSE_READ` | CORE |  | 5 |
...
| `event_2022_011_st-eve-2211-marathon-raid` | 舌戦開幕！賛美の湯 | `SUPPORT` | `POST_E1_REASSESSED_SUPPORT_DEFERRED` | CORE |  | 5 |
| `event_2022_012_st-eve-2212-race` | 君と願う月灯の祝祭 | `SUPPORT` | `POST_E1_REASSESSED_SUPPORT_DEFERRED` | CORE | Y | 5 |
| `event_2023_001_st-eve-2301-contest` | 最高優美＊飛躍のカウントダウン | `IMPORTANT` | `POST_E1_REASSESSED_PENDING_CLOSE_READ` | IMPORTANT | Y | 5 |
...
| `event_2023_004_st-eve-2304-marathon-raid` | 音色の輝石が紡ぐ未来 | `IMPORTANT` | `POST_E1_REASSESSED_PENDING_CLOSE_READ` | CORE |  | 5 |
...
| `event_2023_007_st-eve-2307-race` | 灼熱のBEACH ～イライラMAX ⅢX～ | `SUPPORT` | `POST_E1_REASSESSED_SUPPORT_DEFERRED` | IMPORTANT | Y | 5 |
| `event_2023_008_st-eve-2308-marathon-raid` | おしごとシークレット | `IMPORTANT` | `POST_E1_REASSESSED_PENDING_CLOSE_READ` | IMPORTANT | Y | 5 |
| `event_2023_009_st-eve-2309-backside` | 遥か頂に向かう秀麗 | `CORE` | `PASS_B_EVENT_E1B_AUDITED` | CORE | Y | 5 |
| `event_2023_010_st-eve-2310-race` | 迷走ピリオド 涼やかな青春 | `IMPORTANT` | `POST_E1_REASSESSED_PENDING_CLOSE_READ` | IMPORTANT |  | 5 |
...
| `event_2024_003_st-eve-2403-race` | 笑顔のSUNNY 繋げるPEACE | `IMPORTANT` | `POST_E1_REASSESSED_PENDING_CLOSE_READ` | CORE | Y | 5 |
| `event_2024_004_st-eve-2404-dice` | 不屈のChallenger～Roll the dice～ | `IMPORTANT` | `POST_E1_REASSESSED_PENDING_CLOSE_READ` | IMPORTANT | Y | 5 |
...
| `event_2024_007_st-eve-2407-dice` | 漕ぎ出せ！アイドル★サバイバーズ | `IMPORTANT` | `POST_E1_REASSESSED_PENDING_CLOSE_READ` | CORE |  | 5 |
| `event_2024_008_st-eve-2408-race` | 偽りのREALISM ～密着 新曲会議！？～ | `CORE` | `PASS_B_EVENT_E1C_AUDITED` | CORE | Y | 5 |
| `event_2024_009_st-eve-2409-marathon-raid` | 開演！ぷりてぃー★エンジェル | `IMPORTANT` | `POST_E1_REASSESSED_PENDING_CLOSE_READ` | IMPORTANT |  | 5 |
...
| `event_2025_001_st-eve-2501-race` | 迎春！翼に込める躍進の一念 | `IMPORTANT` | `POST_E1_REASSESSED_PENDING_CLOSE_READ` | CORE |  | 5 |
...
| `event_2025_004_st-eve-2504-marathon-raid` | 旗揚げ！劇団★見～二人のアリスとWONDERLAND～ | `IMPORTANT` | `POST_E1_REASSESSED_PENDING_CLOSE_READ` | CORE |  | 5 |
| `event_2025_005_st-eve-2507-free` | st-eve-2507-free | `CORE` | `PASS_B_EVENT_E1D_AUDITED` | CORE |  | 5 |
| `event_2025_006_st-eve-2507-race` | 星見プロ全国ツアー　Stars Journey | `IMPORTANT` | `POST_E1_REASSESSED_PENDING_CLOSE_READ` | CORE |  | 5 |
...
| `event_2025_009_st-eve-2510-marathon-raid` | 私達の青春謳歌～DOTABATA SCHOOL FESTIVAL～ | `IMPORTANT` | `POST_E1_REASSESSED_PENDING_CLOSE_READ` | IMPORTANT | Y | 5 |
| `event_2025_010_st-eve-2511-race` | let's 湯けむり dancing！ | `IMPORTANT` | `POST_E1_REASSESSED_PENDING_CLOSE_READ` | CORE |  | 5 |
| `event_2025_011_st-eve-2512-dice` | ドタバタ！？トラブルクリスマス！ | `LOW` | `RERANKED_PENDING_CLOSE_READ` | — |  | 3 |
| `event_2026_001_st-eve-2601-race` | 新春万福　素顔の晒し合いGAME | `IMPORTANT` | `POST_E1_REASSESSED_PENDING_CLOSE_READ` | CORE | Y | 5 |
...
| `event_2026_004_st-eve-2604-dice` | IDOLY MATCH～地下闘技場への挑戦～ | `IMPORTANT` | `POST_E1_REASSESSED_PENDING_CLOSE_READ` | IMPORTANT | Y | 5 |
| `event_2026_005_st-eve-2605-marathon-raid` | ハロー！アイドル♪ 夢でつながるミラクルステージ | `LOW` | `RERANKED_PENDING_CLOSE_READ` | IMPORTANT |  | 3 |
| `event_2026_006_st-eve-2606-dice` | 羽ばたけ！恩返しのAile | `IMPORTANT` | `POST_E1_REASSESSED_PENDING_CLOSE_READ` | — | Y | 5 |
...
**Next analytical operation:** **Phase 1B — Post-E1 E2 Reassessment / Fine-Order Rerank.**

Reassess the 26 E2 events against the complete `IDOLY_PRIDE_V2_PHASE1B_POST_EVENT_E1E_BASELINE.md` before any E2 close reading. The old fine-grained E2 order is routing evidence, not immutable authority.

**Recommended model:** GPT-5.6 Sol  
**Recommended reasoning level:** **Extra High**

**Governing inherited state:** `IDOLY_PRIDE_V2_PHASE1B_POST_EVENT_E1E_BASELINE.md` (which inherits E1-D through E1-A and the frozen post-Tier-A baseline).
...
**Formal open items:** `big4_013_the_moonlight`, `stellar_011_all_my_youth`, `adv-live-eve-2602-dice-05`, and `adv-live-eve-2603-race-05` retain audiovisual backfill routes. Earlier E1 formal gaps remain separately governed by their tranche audits.
