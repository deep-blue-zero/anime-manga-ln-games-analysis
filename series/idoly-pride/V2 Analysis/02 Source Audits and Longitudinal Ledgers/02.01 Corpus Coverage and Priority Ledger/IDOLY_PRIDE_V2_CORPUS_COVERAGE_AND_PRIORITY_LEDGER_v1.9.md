...
version: "1.9-phase-1b"
status: "phase-1b-event-e1c-frozen-working-ledger"
source_snapshot_id: "IP-V2-SNAPSHOT-2026-08-13-A"
source_cutoff: "2026-08-13"
created: "2026-08-13"
updated: "2026-08-15"
supersedes_working_version: "1.8-phase-1b"
...
**E1 mandatory-event progress:** **11/16 E1 events admitted through frozen tranche audits.**

**Next analytical operation:** Phase 1B Event Close Read — **E1-D: IIIX United States dissolution/re-authorization**:

1. `event_2025_005_st-eve-2507-free`
2. `event_2025_007_st-eve-2508-free`

**Operation:** treat E1-D as one hard two-part dependency chain. Read prospectively against the frozen post-E1-C baseline, freeze source-native findings before historical comparison, then emit the E1-D audit and successor baseline.

**Recommended model:** GPT-5.6 Sol  
**Recommended reasoning level:** **Extra High**

**Governing inherited state:** `IDOLY_PRIDE_V2_PHASE1B_POST_EVENT_E1C_BASELINE.md` (which inherits post-E1-B, post-E1-A, and the frozen post-Tier-A baseline).
