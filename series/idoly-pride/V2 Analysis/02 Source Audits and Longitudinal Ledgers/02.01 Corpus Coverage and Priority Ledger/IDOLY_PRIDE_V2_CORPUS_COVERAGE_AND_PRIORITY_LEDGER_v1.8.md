...
version: "1.8-phase-1b"
status: "phase-1b-event-e1b-frozen-working-ledger"
source_snapshot_id: "IP-V2-SNAPSHOT-2026-08-13-A"
source_cutoff: "2026-08-13"
created: "2026-08-13"
updated: "2026-08-15"
supersedes_working_version: "1.7-phase-1b"
...
**Next analytical operation:** Phase 1B Event Close Read — **E1-C**:

1. `event_2024_008_st-eve-2408-race`
2. `event_2024_010_st-eve-2410-dice`
3. `event_2024_011_st-eve-2411-race`

**Operation:** read E1-C prospectively against the frozen post-E1-B baseline, freeze primary findings before historical comparison, then emit the E1-C audit and successor baseline.

**Recommended model:** GPT-5.6 Sol  
**Recommended reasoning level:** **Extra High**

**Governing inherited state:** `IDOLY_PRIDE_V2_PHASE1B_POST_EVENT_E1B_BASELINE.md` (which inherits post-E1-A and the frozen post-Tier-A baseline).
