...
version: "1.6-phase-1b"
status: "phase-1b-event-rerank-frozen-working-ledger"
source_snapshot_id: "IP-V2-SNAPSHOT-2026-08-13-A"
source_cutoff: "2026-08-13"
created: "2026-08-13"
updated: "2026-08-15"
supersedes_working_version: "1.5-phase-1b"
...
| `event_2021_004_st-eve-2110-marathon` | 煌めく奇跡をもう一度 | `CORE` | `RERANKED_PENDING_CLOSE_READ` | IMPORTANT |  | 6 |
...
| `event_2022_007_st-eve-2207-contest` | Happy Smile Selfie | `CORE` | `RERANKED_PENDING_CLOSE_READ` | CORE |  | 5 |
...
| `event_2022_010_st-eve-2210-race` | 運命繋ぐ流星の軌跡 | `CORE` | `RERANKED_PENDING_CLOSE_READ` | CORE | Y | 5 |
...
| `event_2023_006_st-eve-2306-contest` | 星々が奇跡と叶える約束の未来 | `CORE` | `RERANKED_PENDING_CLOSE_READ` | CORE |  | 5 |
...
**Next analytical output:** `IDOLY_PRIDE_V2_PHASE1B_EVENT_RERANK_AUDIT.md`.

**Operation:** independently rerank all **60 event bundles** against the frozen Tier-A baseline before event close reading.

**Recommended model:** GPT-5.6 Sol  
**Recommended reasoning level:** **Extra High**

**Governing inherited state:** `IDOLY_PRIDE_V2_PHASE1B_POST_TIER_A_MAIN_NARRATIVE_BASELINE.md`.
