...
version: "1.7-phase-1b"
status: "phase-1b-event-e1a-frozen-working-ledger"
source_snapshot_id: "IP-V2-SNAPSHOT-2026-08-13-A"
source_cutoff: "2026-08-13"
created: "2026-08-13"
updated: "2026-08-15"
supersedes_working_version: "1.6-phase-1b"
...
| Item ID | Title | Priority | Status | H | AV | Stories |
|---|---|---|---|---|:---:|---:|
| `event_2021_001_st-eve-2107-tour` | 雨上がりの太陽と共に | `SUPPORT` | `RERANKED_PENDING_CLOSE_READ` | IMPORTANT |  | 5 |
| `event_2021_002_st-eve-2108-tour` | 月夜に輝く恋の魔法 | `LOW` | `RERANKED_PENDING_CLOSE_READ` | IMPORTANT |  | 5 |
| `event_2021_003_st-eve-2109-backside` | 芽吹く黒ユリの蕾 | `IMPORTANT` | `RERANKED_PENDING_CLOSE_READ` | IMPORTANT |  | 5 |
| `event_2021_004_st-eve-2110-marathon` | 煌めく奇跡をもう一度 | `CORE` | `PASS_B_EVENT_E1A_AUDITED` | IMPORTANT |  | 6 |
| `event_2021_005_st-eve-2111-backside` | 夢踊るステージに架け橋を | `IMPORTANT` | `RERANKED_PENDING_CLOSE_READ` | IMPORTANT |  | 5 |
| `event_2021_006_st-eve-2112-marathon` | 羽休む聖夜のサプライズ | `IMPORTANT` | `RERANKED_PENDING_CLOSE_READ` | IMPORTANT |  | 5 |
| `event_2022_001_st-eve-2201-contest` | 昇る初陽に咲く笑顔 | `SUPPORT` | `RERANKED_PENDING_CLOSE_READ` | IMPORTANT |  | 5 |
| `event_2022_002_st-eve-2202-marathon` | 心愛溶けるビターチョコレート | `IMPORTANT` | `RERANKED_PENDING_CLOSE_READ` | IMPORTANT |  | 5 |
| `event_2022_003_st-eve-2203-race` | 並び立つ歌姫のフルリール | `IMPORTANT` | `RERANKED_PENDING_CLOSE_READ` | IMPORTANT |  | 6 |
| `event_2022_004_st-eve-2204-contest` | 愛歌う星の継承者 | `IMPORTANT` | `RERANKED_PENDING_CLOSE_READ` | CORE |  | 6 |
| `event_2022_005_st-eve-2205-race` | 心紡ぎ合う輝きの競演 | `IMPORTANT` | `RERANKED_PENDING_CLOSE_READ` | CORE |  | 5 |
| `event_2022_006_st-eve-2206-marathon` | 導きのファンファーレ | `SUPPORT` | `RERANKED_PENDING_CLOSE_READ` | IMPORTANT |  | 5 |
| `event_2022_007_st-eve-2207-contest` | Happy Smile Selfie | `CORE` | `PASS_B_EVENT_E1A_AUDITED` | CORE |  | 5 |
| `event_2022_008_st-eve-2208-backside` | 熱中☆ハプニングサマー | `SUPPORT` | `RERANKED_PENDING_CLOSE_READ` | IMPORTANT |  | 5 |
| `event_2022_009_st-eve-2209-contest` | 未来とつながるマジカルメロディ | `LOW` | `RERANKED_PENDING_CLOSE_READ` | IMPORTANT | Y | 5 |
| `event_2022_010_st-eve-2210-race` | 運命繋ぐ流星の軌跡 | `CORE` | `PASS_B_EVENT_E1A_AUDITED` | CORE | Y | 5 |
| `event_2022_011_st-eve-2211-marathon-raid` | 舌戦開幕！賛美の湯 | `IMPORTANT` | `RERANKED_PENDING_CLOSE_READ` | CORE |  | 5 |
| `event_2022_012_st-eve-2212-race` | 君と願う月灯の祝祭 | `IMPORTANT` | `RERANKED_PENDING_CLOSE_READ` | CORE | Y | 5 |
| `event_2023_001_st-eve-2301-contest` | 最高優美＊飛躍のカウントダウン | `IMPORTANT` | `RERANKED_PENDING_CLOSE_READ` | IMPORTANT | Y | 5 |
| `event_2023_002_st-eve-2302-marathon-raid` | 守れ！純潔のベーゼ～imposition of love～ | `SUPPORT` | `RERANKED_PENDING_CLOSE_READ` | IMPORTANT |  | 5 |
| `event_2023_003_st-eve-2303-race` | ぱじゃまパーティー！～夢見る少女と眠り姫～ | `SUPPORT` | `RERANKED_PENDING_CLOSE_READ` | IMPORTANT | Y | 5 |
| `event_2023_004_st-eve-2304-marathon-raid` | 音色の輝石が紡ぐ未来 | `IMPORTANT` | `RERANKED_PENDING_CLOSE_READ` | CORE |  | 5 |
| `event_2023_005_st-eve-2305-race` | きょうえん！HTT＆HMA～放課後ティータイム＆星見アンバサダー～ | `LOW` | `RERANKED_PENDING_CLOSE_READ` | — |  | 3 |
| `event_2023_006_st-eve-2306-contest` | 星々が奇跡と叶える約束の未来 | `CORE` | `PASS_B_EVENT_E1A_AUDITED` | CORE |  | 5 |
| `event_2023_007_st-eve-2307-race` | 灼熱のBEACH ～イライラMAX ⅢX～ | `IMPORTANT` | `RERANKED_PENDING_CLOSE_READ` | IMPORTANT | Y | 5 |
| `event_2023_008_st-eve-2308-marathon-raid` | おしごとシークレット | `IMPORTANT` | `RERANKED_PENDING_CLOSE_READ` | IMPORTANT | Y | 5 |
| `event_2023_009_st-eve-2309-backside` | 遥か頂に向かう秀麗 | `CORE` | `RERANKED_PENDING_CLOSE_READ` | CORE | Y | 5 |
| `event_2023_010_st-eve-2310-race` | 迷走ピリオド 涼やかな青春 | `IMPORTANT` | `RERANKED_PENDING_CLOSE_READ` | IMPORTANT |  | 5 |
| `event_2023_011_st-eve-2311-marathon-raid` | 翔けぬけるVictoire　誓いのplume | `CORE` | `RERANKED_PENDING_CLOSE_READ` | CORE | Y | 5 |
| `event_2023_012_st-eve-2312-contest` | 君と輝くサンシャイン!! | `LOW` | `RERANKED_PENDING_CLOSE_READ` | IMPORTANT | Y | 5 |
| `event_2024_001_st-eve-2401-race` | にゃんか不思議なお正月！？ | `LOW` | `RERANKED_PENDING_CLOSE_READ` | — |  | 5 |
| `event_2024_002_st-eve-2402-contest` | 未来を彩るスノーフェスティバル | `LOW` | `RERANKED_PENDING_CLOSE_READ` | IMPORTANT | Y | 5 |
| `event_2024_003_st-eve-2403-race` | 笑顔のSUNNY 繋げるPEACE | `IMPORTANT` | `RERANKED_PENDING_CLOSE_READ` | CORE | Y | 5 |
| `event_2024_004_st-eve-2404-dice` | 不屈のChallenger～Roll the dice～ | `IMPORTANT` | `RERANKED_PENDING_CLOSE_READ` | IMPORTANT | Y | 5 |
| `event_2024_005_st-eve-2405-race` | すれ違いのディソナンス | `CORE` | `RERANKED_PENDING_CLOSE_READ` | CORE | Y | 5 |
| `event_2024_006_st-eve-2406-contest` | 君を照らすムーンライトロード | `CORE` | `RERANKED_PENDING_CLOSE_READ` | CORE |  | 5 |
| `event_2024_007_st-eve-2407-dice` | 漕ぎ出せ！アイドル★サバイバーズ | `IMPORTANT` | `RERANKED_PENDING_CLOSE_READ` | CORE |  | 5 |
| `event_2024_008_st-eve-2408-race` | 偽りのREALISM ～密着 新曲会議！？～ | `CORE` | `RERANKED_PENDING_CLOSE_READ` | CORE | Y | 5 |
| `event_2024_009_st-eve-2409-marathon-raid` | 開演！ぷりてぃー★エンジェル | `IMPORTANT` | `RERANKED_PENDING_CLOSE_READ` | IMPORTANT |  | 5 |
| `event_2024_010_st-eve-2410-dice` | お待たせしました里帰り～星見凱旋記～ | `CORE` | `RERANKED_PENDING_CLOSE_READ` | CORE | Y | 5 |
| `event_2024_011_st-eve-2411-race` | 欺瞞の最強TWINkle | `CORE` | `RERANKED_PENDING_CLOSE_READ` | CORE | Y | 5 |
| `event_2024_012_st-eve-2412-contest` | 心跳ねるクリスマスパーティー | `LOW` | `RERANKED_PENDING_CLOSE_READ` | — | Y | 5 |
| `event_2025_001_st-eve-2501-race` | 迎春！翼に込める躍進の一念 | `IMPORTANT` | `RERANKED_PENDING_CLOSE_READ` | CORE |  | 5 |
| `event_2025_002_st-eve-2502-marathon-raid` | 感謝を伝えるLovely Valentine's Day | `SUPPORT` | `RERANKED_PENDING_CLOSE_READ` | IMPORTANT | Y | 5 |
| `event_2025_003_st-eve-2503-dice` | SOS！星見プロダクションの転送～ただのアイドルには興味ありません！？～ | `LOW` | `RERANKED_PENDING_CLOSE_READ` | — |  | 3 |
| `event_2025_004_st-eve-2504-marathon-raid` | 旗揚げ！劇団★見～二人のアリスとWONDERLAND～ | `IMPORTANT` | `RERANKED_PENDING_CLOSE_READ` | CORE |  | 5 |
| `event_2025_005_st-eve-2507-free` | st-eve-2507-free | `CORE` | `RERANKED_PENDING_CLOSE_READ` | CORE |  | 5 |
| `event_2025_006_st-eve-2507-race` | 星見プロ全国ツアー　Stars Journey | `IMPORTANT` | `RERANKED_PENDING_CLOSE_READ` | CORE |  | 5 |
| `event_2025_007_st-eve-2508-free` | st-eve-2508-free | `CORE` | `RERANKED_PENDING_CLOSE_READ` | CORE | Y | 5 |
| `event_2025_008_st-eve-2509-contest` | 未来へ続く夏祭り | `LOW` | `RERANKED_PENDING_CLOSE_READ` | IMPORTANT | Y | 5 |
| `event_2025_009_st-eve-2510-marathon-raid` | 私達の青春謳歌～DOTABATA SCHOOL FESTIVAL～ | `IMPORTANT` | `RERANKED_PENDING_CLOSE_READ` | IMPORTANT | Y | 5 |
| `event_2025_010_st-eve-2511-race` | let's 湯けむり dancing！ | `IMPORTANT` | `RERANKED_PENDING_CLOSE_READ` | CORE |  | 5 |
| `event_2025_011_st-eve-2512-dice` | ドタバタ！？トラブルクリスマス！ | `LOW` | `RERANKED_PENDING_CLOSE_READ` | — |  | 3 |
| `event_2026_001_st-eve-2601-race` | 新春万福　素顔の晒し合いGAME | `IMPORTANT` | `RERANKED_PENDING_CLOSE_READ` | CORE | Y | 5 |
| `event_2026_002_st-eve-2602-dice` | ぶつかり愛のCenter Battle！ | `CORE` | `RERANKED_PENDING_CLOSE_READ` | CORE | Y | 5 |
| `event_2026_003_st-eve-2603-race` | あなたに捧ぐWith your songs | `CORE` | `RERANKED_PENDING_CLOSE_READ` | CORE | Y | 5 |
| `event_2026_004_st-eve-2604-dice` | IDOLY MATCH～地下闘技場への挑戦～ | `IMPORTANT` | `RERANKED_PENDING_CLOSE_READ` | IMPORTANT | Y | 5 |
| `event_2026_005_st-eve-2605-marathon-raid` | ハロー！アイドル♪ 夢でつながるミラクルステージ | `LOW` | `RERANKED_PENDING_CLOSE_READ` | IMPORTANT |  | 3 |
| `event_2026_006_st-eve-2606-dice` | 羽ばたけ！恩返しのAile | `IMPORTANT` | `RERANKED_PENDING_CLOSE_READ` | — | Y | 5 |
| `event_2026_007_st-eve-2607-marathon-raid` | PRIDE貫く頂点への道標 | `CORE` | `RERANKED_PENDING_CLOSE_READ` | — |  | 5 |
...
**Next analytical operation:** Phase 1B Event Close Read — **E1-B**:

1. `event_2023_009_st-eve-2309-backside`
2. `event_2023_011_st-eve-2311-marathon-raid`
3. `event_2024_005_st-eve-2405-race`
4. `event_2024_006_st-eve-2406-contest`

**Operation:** read E1-B prospectively against the frozen Tier-A + post-E1-A baseline, freeze primary findings before historical comparison, then emit the E1-B audit and successor baseline.

**Recommended model:** GPT-5.6 Sol  
**Recommended reasoning level:** **Extra High**

**Governing inherited state:** `IDOLY_PRIDE_V2_PHASE1B_POST_EVENT_E1A_BASELINE.md` (which inherits the frozen post-Tier-A baseline).

**Lower-tier rule:** later sources may extend, stabilize, recur, revise, contradict, temporally mature, add texture, require formal review, or correct chronology. They may not silently backfill mature states into earlier Tier-A chronology.

**Formal open items:** `big4_013_the_moonlight` and `stellar_011_all_my_youth` retain audiovisual backfill routes.
