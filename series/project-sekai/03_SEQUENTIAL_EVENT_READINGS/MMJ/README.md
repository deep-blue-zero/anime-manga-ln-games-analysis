...
Since import, [EVENT_0073](PJSK_EVENT_0073_DEEP_READING.md) supplies a complete-envelope reading with MMJ interpretation preserved for later foundation-aware integration. The empty-folder statement above describes the import snapshot; this directory is now populated. MMJ's main-story foundation is complete; EVENT_0073 baseline-relative integration still awaits its intervening ordered routes.

[EVENT_0078](PJSK_EVENT_0078_DEEP_READING.md) adds the complete 23-surface shared reading of Haruka’s origin, MMJ’s larger goal and publicity decision, with a bounded Shiho sibling route. MMJ and Leo/need longitudinal impact remains deferred pending their intervening ordered historical routes; both foundations are complete.
...
- [EVENT_0057 — つなぐPainful Hope](PJSK_EVENT_0057_DEEP_READING.md): complete-envelope reading centered on Haruka's bounded helping ethic and creator/fan reciprocity; current founded-unit consequence is governed by the EVENT_0029–0090 backfill checkpoint.

- [EVENT_0067 — 青空の先、輝きを追いかけて](PJSK_EVENT_0067_DEEP_READING.md): complete-envelope reading centered on Airi's person-specific visibility theory and Minori's expression training; current founded-unit consequence is governed by the EVENT_0029–0090 backfill checkpoint.
