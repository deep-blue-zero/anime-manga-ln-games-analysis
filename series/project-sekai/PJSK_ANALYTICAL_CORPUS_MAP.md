...
**Coverage qualification:** the imported routing inventory still explicitly marks 20 earlier events `PENDING_ONE_TIME_UNIVERSAL_SCREEN`: `0003`, `0005`, `0006`, `0008`, `0010–0013`, `0015–0018`, `0020–0025`, and `0027–0028`. EVENT_0001 has since closed its historical universal screen; these remaining rows are unresolved. Thus “routing through EVENT_0072” identifies the inventory/frontier, not gap-free completed franchise screening. Preserve the completed EVENT_0046–0090 universal screens and reusable earlier completed envelopes. Close the listed backlog once, and consume deferred routes against the completed unit foundations; do not repeat discovery separately for each unit.
