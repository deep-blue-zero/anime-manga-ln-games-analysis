---
title: "Tokyo 7th Sisters — B0001 Deep Reading"
artifact_id: T7S_B0001_DEEP_READING
...
status: canonical
scope: T7S_B0001
episode_id: "201000001"
script_id: scout_000_00_01.json__8df3fd723276f650
native_hierarchy: "2034年 / EPISODE 1.0 / アバンタイトル / 始まりの日 (第0話)"
corpus_alias: c20260909-r484
witness_id: T7S_GAME_OFFLINE_JA_R484
language: ja
analysis_language: en
source_boundary: "Episode 201000001 only; primary document pages/logs 0–194; both authored choice branches; no later story source"
source_pages: 195
source_text_records: 190
voice_references: 101
...
# Tokyo 7th Sisters — B0001 deep reading

## Beginning after the ending: inherited love, new institutional labor, and a future that cannot be copied

## 0. Result, scope, and evidence posture

B0001 closes one complete source: episode `201000001`, アバンタイトル / 始まりの日 (第0話). Its governing dramatic movement is not “the old idols return,” but **an ending being converted into permission and obligation to begin differently**. The episode first makes Seven Sisters monumental, then shows that the Player's devotion to that image has become immobilizing. 六咲コニー does not ask the Player to reproduce the miracle. She changes the task from finding another Seven Sisters to making an idol form born from the present: `新しい、『今』のアイドル像`. The episode therefore establishes succession as revision, not replication.

The complete primary document was read in native log order, including the five pages without dialogue, the movie command, the HoloCom item presentation, the choice at page 151, and both authored outcomes before their convergence. The packet and live structured source are byte-identical at SHA-256 `a4d9b47d19b16a3829695a8c2da3b594ec13dcd303d7a9c4fd6917100e163939`. The database, episode catalog, source-artifact manifest, and collection manifest match the immutable source lock. The exact episode row resolves to one primary document, 195 pages/logs (0–194), 190 text records, and no inline child document.

No later story source is used. All machine identity-resolution fields in this episode remain `unresolved`; the analysis therefore preserves the literal labels `PLAYER`, `支配人`, `六咲コニー`, `七咲ニコル`, and compound labels. Analytical subject routes below are document-local conveniences, not corpus-wide identity resolutions.

### 0.1 Locator key and high-value evidence

Every script locator below uses the immutable alias, exact script, mandatory `doc=primary`, zero-based log cross-check, and native JSON pointer.

| Key | Exact locator | What it establishes |
| --- | --- | --- |
| E01 | `t7s://c20260909-r484/v1/script/scout_000_00_01.json__8df3fd723276f650?doc=primary&log=11#/Pages/11/TextArea/Dialogue` | Nicole's “ending / beginning from here” declaration |
| E02 | `t7s://c20260909-r484/v1/script/scout_000_00_01.json__8df3fd723276f650?doc=primary&log=25#/Pages/25/TextArea/Dialogue` | Player's dream of making a “second Seven Sisters” |
| E03 | `t7s://c20260909-r484/v1/script/scout_000_00_01.json__8df3fd723276f650?doc=primary&log=26#/Pages/26/TextArea/Dialogue` | Player's belief that girls like them will not appear again |
...
| E12 | `t7s://c20260909-r484/v1/script/scout_000_00_01.json__8df3fd723276f650?doc=primary&log=159#/Pages/159/TextArea/Dialogue` | Branch convergence: “new Nanasta” |
| E13 | `t7s://c20260909-r484/v1/script/scout_000_00_01.json__8df3fd723276f650?doc=primary&log=174#/Pages/174/TextArea/Dialogue` | “Appearance” versus “contents” maxim |
| E14 | `t7s://c20260909-r484/v1/script/scout_000_00_01.json__8df3fd723276f650?doc=primary&log=186#/Pages/186/TextArea/Dialogue` | Player nearly completes the `ナナサ…` recognition |
| E15 | `t7s://c20260909-r484/v1/script/scout_000_00_01.json__8df3fd723276f650?doc=primary&log=194#/Pages/194/TextArea/Dialogue` | First forward action: go scout girls |

Ranges in the reconstruction below are inclusive. The canonical episode route is `t7s://c20260909-r484/v1/episode/201000001`.

## 1. Descriptive reconstruction

### 1.1 A spectacular last live, then a hard cut to aftermath (pages 0–14)

The episode opens in a packed, light-filled concert space. Crowd lines summon “Sevenths” and individual performers before the literal label `七咲ニコル` declares that today is the group's last live. Her next line refuses a purely terminal meaning: `終わりだけど！ ここから、はっじまるよーーーーー！！`—it is an ending, but “from here” a beginning. The line is not yet an instruction to the Player; it is footage the Player has been watching. Its force will be recognized only after the episode shows how badly the Player has misunderstood inheritance. [E01; pages 0–11]

Page 12 fades to white. Page 13 then issues a blocking movie command for `movie_adv_system_001_blocking_01.mp4` and separately cues `StarGlitter_1` after 400 ms; page 14 fades into the Nanasta office. The decoded 123.933-second, 640×360 movie has no embedded audio stream, so the script's separate music command must remain a distinct occurrence rather than be treated as an audio track proved inside the file.

The movie's reviewed frames present the franchise title, individual school-age girls with name cards, city settings, changing small-group arrangements, a darker isolated red-haired figure, and an eventual larger ensemble. Because the current scene has not yet established any Nanasta idols, this is best read as **proleptic presentation for the audience**, not as evidence that the Player is watching those future girls in-world. It creates audience/Player asymmetry: the audience is shown a plurality that the Player still believes cannot exist. It must not be conflated with the dissolution-live video merely because it follows that scene.

### 1.2 Love narrowed into repetition (pages 15–27)

Back in the office, the Player praises Seven Sisters and supplies highly stylized pitches for 羽生田ミト, 御園尾マナ, 寿クルト, 若王子ルイ, 遊佐メモル, and 七咲ニコル. These are not neutral encyclopedia descriptions. They are the rhetoric of an admirer replaying a unit as a completed miracle. The Player recalls joining Nanasta to scout cute girls, raise them into idols, and make `第２のセブンスシスターズ`; that aspiration collapses into the belief that “girls like that” will not appear anymore. [E02–E03; pages 15–27]

The emotional problem is therefore more exact than lack of love. The Player has abundant love but has allowed a singular historical image to define what counts as a possible idol. Admiration becomes a filter that makes the present look empty. The episode will not cure devotion; it will uncouple devotion from imitation.

### 1.3 The institution still exists, but its social circuit has failed (pages 28–67)

The literal `支配人` interrupts and introduces himself as the first manager of the next-generation idol theater studio Three Seven, “Nanasta.” A comic metaleptic exchange—he addresses the person meeting him for the first time, while the Player insists they have met many times—prioritizes onboarding clarity without erasing the characters' pre-existing workplace familiarity. The Player's exchanges throughout the scene confirm that they already know his habits, finances, scouting failures, and evasions.

The Player has been rewatching the dissolution live because there is little work to do. Streaming viewership is poor, and the studio has no material left to distribute. The first manager then supplies the broader diagnosis: Seven Sisters disbanded two years ago; idol culture lost force; the era is called an `アイドル氷河期`; the HakoSta model of training, distribution, and live performance has receded; and even centrally located Nanasta stands deserted. [E04; pages 40–64]

Those broad social claims remain **his attributed account**, not omniscient narration. The Player independently corroborates the local operational facts—poor viewership, no content, and an underused facility despite its location—but does not independently prove that idol culture everywhere is literally dead. The current scene is explicitly 2034 [E06]; the last live is therefore established only as two years before this scene, not assigned an exact calendar date by arithmetic.

The reviewed backgrounds sharpen the institutional claim. The opening concert image is dense with crowd, confetti, lights, and scale. Nanasta's office is bright and materially serviceable, with desks, seating, boxes, posters, and equipment. The contrast does not show a ruined building. It shows **infrastructure without a living attention-and-participation circuit**: a workplace can remain physically present while its performers, content, audience, and confidence disappear.

### 1.4 Succession is imposed before it is chosen (pages 68–130)
...
### 1.6 An ordinary-looking device, an unresolved person, and the first next action (pages 161–194)
...
### 2.1 “Beginning day” is an argument about inheritance
...
### 2.4 Japanese textual voices

These are linguistic observations only; they do not claim performed delivery.

- `PLAYER` uses `僕` and usually polite endings, but performs a persistent straight-man function. Direct corrections—there is no upper management, the manager is fleeing, the HoloCom cannot be ancient—show epistemic and ethical resistance inside deference. Parenthetical reactions also give the audience an evaluative foothold.
...
The reviewed blocking movie is exactly bound by:

- occurrence: `t7s://c20260909-r484/v1/record/media%3Avideo_relations.jsonl/1390`
- asset: `t7s://c20260909-r484/v1/asset/movie%3Af812aa04b4d4b244148f186f3dd88d52a85d8f0f512e0444caddc45b7407f225?kind=video`
- command: `t7s://c20260909-r484/v1/script/scout_000_00_01.json__8df3fd723276f650?doc=primary&log=13#/Pages/13/InlineMovie/FileName`

The concert and office stills were manually adjudicated from candidate relations against their exact logical names and native pointers in this one-document script:

- concert image: `t7s://c20260909-r484/v1/asset/image%3Asha256%3A093d61fa9fc034dc3e5678c3ece3fc000c764a368b222e2eee635ab16f4785a9?kind=visual`
- office image: `t7s://c20260909-r484/v1/asset/image%3Asha256%3A379dbfbea3c8fe25bdae793a81d879fb0692c1f1b4cd121dbae03564b40ed557?kind=visual`
- HoloCom item: `t7s://c20260909-r484/v1/asset/image%3Asha256%3A5f8f7e302456a74fb0b57ecbf770b18515cfba5aabadb7c692f2db788e7ed322?kind=visual`

The visual relations for those stills retain `document_ref = NULL`; the manual selection is bounded, not a repair to source identity. The visual evidence supports composition, contrast, and audience-facing sequence. It does not prove continuous motion outside the movie, performed vocal affect, music mix, or exact runtime overlap.

The episode contains 101 voice references, and selected relevant files were recovered for review, but the available transport did not produce listenable audio in this session. Performed voice and the separately cued music therefore remain `QUEUED`. No claim in this reading depends on inferred vocal delivery, acoustic features, or unheard music.

## 3. State handoff

### 3.1 What is now established
...
No character model, character monograph, relationship/unit monograph, specialist study, arc synthesis, or full-series claim is promoted from a single introductory episode. B0001 supports document-local identity routes and state records only. Textual characterization has begun; representative ordinary-life, conflict, relationship, chronology, stage, visual, and actually listened-to performed-voice coverage remain far below any reconstruction or monograph threshold.

## 4. Block closeout

B0001 is fully screened, narratively reconstructed, closely analyzed, and integrated into the three longitudinal ledgers. Visual review is partial and exact; performed voice/music review remains queued and is not load-bearing. The consumed horizon ends at primary page/log 194 after both authored branches. Nothing from the next chapter has been read.

The next candidate is native chapter layer `300020`, ノッキン・オン・セブンス・ドア, beginning with episode `201000101`, subject to a fresh authority/source/entering-horizon check in a separately authorized operation.
