---
title: "Tokyo 7th Sisters — B0004 Deep Reading"
artifact_id: T7S_B0004_DEEP_READING
...
episode_ids:
  ...
  - "201000308"
  - "201000309"
native_hierarchy: "2034年 / EPISODE 1.0 / オール・アバウト・マイ・アイドル"
corpus_alias: c20260909-r484
witness_id: T7S_GAME_OFFLINE_JA_R484
language: ja
analysis_language: en
source_boundary: "Complete native chapter 300040; episodes 201000301–201000309; all primary pages/logs and both authored branches in 201000308; no later story source"
source_pages: 371
source_text_records: 342
command_only_pages: 29
voice_references: 258
...
# Tokyo 7th Sisters — B0004 deep reading

## Inheriting courage without becoming a copy: Rona learns that an idol's effect can precede an idol identity

## 0. Result, scope, and integrity

B0004 closes the complete nine-episode native chapter `300040`, オール・アバウト・マイ・アイドル. Its central problem is not that imitation is intrinsically false. **Copying Nicole once gave a shy, self-described clumsy child the courage to perform and a place among peers; it is a historically successful relational technique. It becomes destructive only when Rona makes resemblance to Nicole the exclusive test of whether she may count as an idol—or as someone capable of helping others. Haru's repair separates aspiration from substitution: Rona can keep Nicole as a goal while recognizing that, as the girl 角森ロナ, she already gives another person courage.** Her return and debut begin that recognition, but the final costume accident immediately reactivates global self-condemnation. The chapter closes a recruitment decision, not the underlying vulnerability.

All 371 primary pages/logs and 342 text records were read in native order, including 29 pages without text. Episode `201000308` contains one authored choice group; both options and all six branch-tagged pages were consumed. Every chapter document is `primary`; there is no inline child document or movie. Page and log indices are contiguous inside every episode, and every present text pointer equals its native `/Pages/<index>/TextArea/Dialogue` location. The immutable database was opened with `mode=ro&immutable=1`, `query_only=ON`, and memory-only temporary storage; its full SHA-256 was reverified as `1bc0bf5d140e675554cf38ed4e3108be3c8c932c375c494bd29d3e4bb7b2ed87`.

| Episode | Native title | Pages / text / command-only | Source SHA-256 |
| --- | --- | ---: | --- |
| `201000301` | 私をアイドルにしてください！ / 第1話 | 77 / 71 / 6 | `d447029f6048902f0b8aaec092ba6ab22b42838fc37fec534db8d26859500530` |
| `201000302` | 憧れのアイドル / 第2話 前編 | 29 / 26 / 3 | `69fd65d6d86d2ece0e4f8e4acad47b021b6793262bbf3465b34358a8bd590187` |
| `201000303` | 憧れのアイドル / 第2話 後編 | 27 / 25 / 2 | `8c55b5cbf531cdd781e64f4ea453f45c60969252dff80bc1170ea36bfb0aa5b8` |
| `201000304` | ロナのこだわり / 第3話 前編 | 38 / 36 / 2 | `86e5dfed2e2ebf87cfa2be56318b29334948d0d7a06275a74d1ba82b6015e24c` |
| `201000305` | ロナのこだわり / 第3話 後編 | 15 / 14 / 1 | `cf2a25856572bae122f91602fa71580164a90fdc28d3ef9320b6125b3d7353f9` |
| `201000306` | かえり道 / 第4話 前編 | 42 / 38 / 4 | `046f89f3d96c3a75214298d3107f68ebd7cf05ecefa4fdbfa441ec127a381cf0` |
| `201000307` | かえり道 / 第4話 後編 | 69 / 66 / 3 | `e4b6bddb5829679749890bab2e676d2b5a947dbeb127cc92893b0f3b0b225039` |
| `201000308` | オール・アバウト・マイ・アイドル / 最終話 前編 | 20 / 18 / 2 | `b471e4027264a4ea17ed6599b1dfb3911bec3f09ca155f87a924c98aea3af775` |
| `201000309` | オール・アバウト・マイ・アイドル / 最終話 後編 | 54 / 48 / 6 | `a4534da0cc8db1debeebef715154bafcf5e509d7927ae781cb688ecd8af51fa3` |
...
| E09 | `t7s://c20260909-r484/v1/script/scout_003_03_02.json__4100baf0d22a17e9?doc=primary&log=20#/Pages/20/TextArea/Dialogue` through `...&log=40#/Pages/40/TextArea/Dialogue` | Childhood imitation memory, planned resignation, and Haru's compelled street battle |
| E10 | `t7s://c20260909-r484/v1/script/scout_003_03_03.json__7522b65ee7406e0a?doc=primary&log=0#/Pages/0/TextArea/Dialogue` through `...&log=24#/Pages/24/TextArea/Dialogue` | Public interest fails to change Rona's likeness test; withdrawal, juice, and shared silence |
...
### 1.1 A legacy first understood as an effect (`201000301`)
...
Rona arrives before the others and cleans Nanasta because it is important to idols and guests. The action places her aspiration in mundane care before formal debut. She explains that she grew up with no perceived strength: clumsy and withdrawn. When she finally dared to imitate Nicole's dance, classmates praised her. Nicole's song pushed her forward and the imitation gave her a place at school. She now wants to give someone else the energy she received. [E06]

Haru, Musubi, and Rona answer one another as a practice group, and the Player notices that three distinct recruits are cohering. He imagines enough new idols reviving Nanasta and perhaps surpassing Seven Sisters. Rona's backward-looking model thus enters an institution whose explicit B0001 mandate is to exceed rather than reproduce the vanished group. [E06]
...
The battle itself is elided. Passersby say idols seemed old but the performance was exciting and ask which HakoSta the girls represent. This is local evidence of public effect and cultural appetite. It does not change Rona's standard: she still says the performance was not Nicole-like. Public approval repeats the kind of evidence that originally made imitation useful, but cannot solve identity foreclosure once likeness has become the criterion. [E10]

Haru pulls Rona away, buys juice, and lets a long silence stand. Only then does she ask what an idol is and disclose her own uncertainty: effort has made the future less, not more, visible. She admits knowing little about Nicole or idols, but can name Rona's particular qualities—care for the theater, close study of performances, seriousness—and wants to work with her. Most decisively, she corrects herself mid-sentence: she has received energy not merely from “the idol Tsunomori Rona,” but from “the girl Tsunomori Rona.” [E10–E11]

Rona asks whether she herself, not Nicole, can give people courage. Haru says yes. The Player, who deliberately let the two speak privately, adds that Rona has already encouraged Nanasta's members and asks her to return. Rona chooses to try again. The repair succeeds because it supplies relation-specific testimony about an effect already produced; it does not demand an abstract declaration of uniqueness or the abandonment of Nicole. [E11]

### 1.6 Aspiration without substitution (`201000308`)

Immediately before her streamed debut, Rona asks whether it is really acceptable for her to be herself and whether she must become like Nicole. In one authored branch the Player says they want to see Tsunomori Rona's idol form. In the other he jokes that resemblance would be preferable and is struck by Haru and Musubi; Rona nevertheless says she wants idol work and will keep Nicole as her goal. Both paths converge on the three girls' collective cheer. [E12]

The branch structure distinguishes two propositions. Rona need not become Nicole in order to appear, but Nicole can remain an aspiration. The stronger branch articulates this cleanly; the comic branch makes the group, including Rona, correct the Player. Neither branch establishes that Rona's self-evaluation is now stable.

### 1.7 A debut of mutual support and an immediate relapse (`201000309`)
...
### 2.1 Imitation is first a scaffold, then an identity foreclosure

Rona's Nicole imitation should not be dismissed as inauthentic fandom. It joins memory, disciplined observation, embodied reproduction, courage, peer recognition, and belonging. She can perform strongly on her first Nanasta test precisely because she has studied a model. The imitation is a scaffold: it permits action before Rona possesses a confident independent account of herself.

The problem begins when a successful technique becomes an exhaustive identity rule. Rona no longer asks whether Nicole's example helps her act; she asks whether every act equals Nicole. A good group performance then counts as failure because difference itself is disqualifying. The chapter's movement is therefore not from copy to originality in one step. It is from **copying as permission to act**, through **copying as a ban on difference**, toward **aspiration that no longer requires substitution**.

### 2.2 Legacy is transmitted through effects, not replicated appearances
...
The street audience provides positive reception, yet Rona remains desolate. Haru's repair works differently because it is particular and directional. She cannot authenticate Rona by expert comparison to Nicole—she openly says she knows little about Nicole. She can testify to what Rona has done in their relationship: cleaning, studying, working seriously, giving Haru energy.

This is not a rejection of publics or stages. The debut still matters. It shows that public identity becomes bearable when preceded by a relation in which worth is not conditional on already possessing that identity. The sequence distinguishes generic applause (“the performance was exciting”) from responsive knowledge (“this is how you affected me”).
...
Rona imagines idols as people who support those who cannot support themselves. Her debut accidentally adds the inverse: she asks viewers to support her. The audience's joke does not simply negate her wording. It makes visible a reciprocal circuit already established among Haru, Musubi, Rona, the Player, and even the waiting/return sequence.

The three girls become a practical collective before the source provides a formal unit name, contract, or role structure. Rona cleans for shared guests; Musubi waits; Haru searches; Rona gives Haru courage; both peers correct the Player's weaker branch; they perform and cheer together. Nanasta's plural identity is being made through distributed support rather than through interchangeable likeness to a central model.

### 2.7 Self-authorship is real but provisional

Rona makes several genuine decisions: she stops the departing scouts, gives her name, asks to become an idol, chooses to return after Haru's testimony, maintains Nicole as an aspiration, appears in the stream, and requests familiar name address as a member. Those acts prevent her from being reduced to a passive recruitment object.

They do not establish stable self-worth. Her recurring verbal pattern moves from an event (`蛇口が壊れた`, a torn costume, a non-Nicole-like practice) to a global identity (`いつものこと`, `弱虫な私`, `こんなドジな私`) and then to categorical exclusion (`アイドルなんて`). The last accident is deliberately mundane: no failed live is required to reactivate the rule. At this horizon she has one corrective relationship and one successful debut, not yet a portable capacity to survive error.
...
| Dimension | Entering state | B0004 exit | Retained limit / next test |
| --- | --- | --- | --- |
...
| AV evidence | Prior bounded still review; performed voice/song queued | Selected B0004 body/face assets were hash-checked and reconstructed with verified native face offsets; backgrounds were inspected; 258 voice-reference pages counted and representative cues recovered | Full runtime placement/animation and audible voice/music were not delivered; street/debut songs are elided; stage-performance claims remain bounded |
...
- Keep performed voice, singing, music, continuous movement, and unshown performances non-load-bearing until actually reviewed evidence exists.
- Do not promote Rona beyond `R2_STATE_BOUNDED` or create a monograph/model from one introduction chapter.

### 3.2 Transaction decision

T7S_B0004 is complete as one chapter-level analytical document. The nine native episodes form a single escalating causal argument—legacy need, voluntary approach, copied skill, identity foreclosure, withdrawal, relational reframe, debut, managerial doctrine, relapse—so compressing them into one document preserves rather than erases their episode-specific functions. The locator/event ledgers retain each materially distinct transition.

The next candidate within the authorized EPISODE 1.0 continuation is episode `201000401`, opening native chapter layer `300050`, プリンセス・シタマチ. Its catalog metadata may be used for routing, but its story content remains unopened until this transaction is validated, committed, published, and the exact remote commit receives a successful repository integration audit.
