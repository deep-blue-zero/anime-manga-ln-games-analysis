...
| --- | ---: | ---: | ---: | ---: | ---: |
| Main | 364 | 19 | 19 | 19 | 19 |
| Sub | 755 | 0 | 0 | 0 | 0 |
| Event | 231 | 0 | 0 | 0 | 0 |
| Additional scripts | 228 | 0 | 0 | 0 | 0 |
| Supplemental records | 30,991 | 0 | 0 | 0 | 0 |

The EPISODE 1.0 frontier is exact and hole-free for 19 episode IDs: `{201000001, 201000101–201000109, 201000201–201000209}`. Its remaining 72 episodes, beginning with `201000301`, and every other Main line plus all Sub/Event/additional/supplemental frontiers remain `NOT_STARTED`. The coverage ledger preserves exact memberships and digest-bound supplemental tranches, so the numeric high-water cannot hide gaps. Across B0001–B0003 the repository now contains three deep readings, 25 causal events, four world states, five open threads, 16 typed edges, seven bounded identity routes, seven character states, nine epistemic states, 20 directional relationship states, four unit/institution states, two R2 readiness decisions, 27 literary claims, two revisions, three frozen predictions, three completed bounded visual reviews, and three queued performed-voice/music reviews. It creates no character model, monograph, specialist, arc/era synthesis, or full-series synthesis. Native 2034/2053 grouping, release chronology, diegetic time, and analytical reading order stay separate.
