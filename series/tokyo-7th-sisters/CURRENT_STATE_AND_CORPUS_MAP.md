...
source_boundary: "c20260909-r484; complete 235-document 2034 Main horizon plus first 58 non-Main i-n-g episodes / T7S_B0080–T7S_B0107 are reconstructed and integrated; remaining 2034 non-Main stays routed; 2053 and crossover semantics remain gated"
...
major_story_structures:
  T7S_STACK_2034:
    ...
    current_semantic_horizon: "through complete EPISODE NANASUTA / T7S_B0079 plus first 28 complete i-n-g chapters / T7S_B0080–T7S_B0107"
...
**B0107 is closed; the authorized B0100–B0159 run is active (8/60 blocks).** The [run record](09%20Audits%20and%20Manifests/T7S_B0100_B0159_EXECUTION_RECORD.md) binds the 174-episode plan and exact checkpoint. [B0107](02%20Readings/T7S_B0107_DEEP_READING.md): Musubi first refuses a national cooking/solo-PR contest, enters after a targeted yakisoba-bread appeal, loses, and later discloses uncertainty about victory and idol identity; the Player offers an open answer, while her next-day lesson request leaves the larger choice unresolved. Performed audio remains unauditioned; the 2034 era release is incomplete and every 2053 semantic operation remains blocked.
