...
Every per-line frontier is `NOT_STARTED`; remaining holes are the full exact sets in the coverage ledger and digest-bound supplemental memberships. No completed block, claim, character model, monograph, specialist or synthesis exists. No story state is inferred from metadata. Native 2034/2053 grouping, release chronology, diegetic time and analytical reading order stay separate.
