...
source_boundary: "c20260909-r484; complete 235-document 2034 Main horizon plus first 79 non-Main i-n-g episodes / T7S_B0080–T7S_B0114 are reconstructed and integrated; remaining 2034 non-Main stays routed; 2053 and crossover semantics remain gated"
...
major_story_structures:
  T7S_STACK_2034:
    ...
    current_semantic_horizon: "through complete EPISODE NANASUTA / T7S_B0079 plus first 35 complete i-n-g chapters / T7S_B0080–T7S_B0114"
...
**B0114 is closed; the authorized B0100–B0159 run is active (15/60 blocks).** The [run record](09%20Audits%20and%20Manifests/T7S_B0100_B0159_EXECUTION_RECORD.md) binds the 174-episode plan and exact checkpoint. [B0114](02%20Readings/T7S_B0114_DEEP_READING.md): Suss passes every retest after peer study, English-dictionary help and Musubi’s eventual rest limit; a father’s return warning and Sawara’s promised access to an unconsulted Player make the successful motivation ethically non-equivalent to consent. Performed audio remains unauditioned; the 2034 era release is incomplete and every 2053 semantic operation remains blocked.
