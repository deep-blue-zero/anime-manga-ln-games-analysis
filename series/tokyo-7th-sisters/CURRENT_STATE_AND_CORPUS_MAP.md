...
| --- | ---: | ---: | ---: | ---: | ---: |
| Main | 364 | 37 | 37 | 37 | 37 |
| Sub | 755 | 0 | 0 | 0 | 0 |
| Event | 231 | 0 | 0 | 0 | 0 |
| Additional scripts | 228 | 0 | 0 | 0 | 0 |
| Supplemental records | 30,991 | 0 | 0 | 0 | 0 |

The EPISODE 1.0 frontier is exact and hole-free for 37 episode IDs: `{201000001, 201000101–201000109, 201000201–201000209, 201000301–201000309, 201000401–201000409}`. Its remaining 54 episodes, beginning with `201000501`, and every other Main line plus all Sub/Event/additional/supplemental frontiers remain `NOT_STARTED`. The coverage ledger preserves exact memberships and digest-bound supplemental tranches, so the numeric high-water cannot hide gaps. Across B0001–B0005 the repository now contains five deep readings, 41 causal events, four world states, eight open threads, 34 typed edges, 14 bounded identity routes, 11 character states, 15 epistemic states, 36 directional relationship states, five unit/institution states, four R2 readiness decisions, 45 literary claims, four revisions, four frozen predictions, five completed bounded visual reviews, and five queued performed-voice/music reviews. It creates no character model, monograph, specialist, arc/era synthesis, or full-series synthesis. Native 2034/2053 grouping, release chronology, diegetic time, and analytical reading order stay separate.
...
The **next candidate within the authorized EPISODE 1.0 continuation** is episode `201000501`, opening chapter layer `300060`, モモカ・ゴー・ホーム！. Its catalog metadata identifies the boundary, but its story content has not been opened. The next reading must recheck current authority, source binding, the complete B0005 entering horizon, and any prospective prerequisite before admission. If an unadmitted dependency becomes load-bearing, pause and record a boundary correction; authorization does not extend outside EPISODE 1.0.
