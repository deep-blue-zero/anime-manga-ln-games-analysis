...
source_boundary: "c20260909-r484; through complete T7S_B0006 / episode 201000509 / primary pages 0–48; B0006 includes both authored branches in 201000504"
...
| --- | ---: | ---: | ---: | ---: | ---: |
| Main | 364 | 46 | 46 | 46 | 46 |
| Sub | 755 | 0 | 0 | 0 | 0 |
| Event | 231 | 0 | 0 | 0 | 0 |
| Additional scripts | 228 | 0 | 0 | 0 | 0 |
| Supplemental records | 30,991 | 0 | 0 | 0 | 0 |

The EPISODE 1.0 frontier is exact and hole-free for 46 episode IDs: `{201000001, 201000101–201000109, 201000201–201000209, 201000301–201000309, 201000401–201000409, 201000501–201000509}`. Its remaining 45 episodes, beginning with `201000601`, and every other Main line plus all Sub/Event/additional/supplemental frontiers remain `NOT_STARTED`. The coverage ledger preserves exact memberships and digest-bound supplemental tranches, so the numeric high-water cannot hide gaps. Across B0001–B0006 the repository now contains six deep readings, 49 causal events, four world states, nine open threads, 43 typed edges, 15 bounded identity routes, 12 character states, 17 epistemic states, 42 directional relationship states, five unit/institution states, five R2 readiness decisions, 54 literary claims, five revisions, four frozen predictions, six completed bounded visual reviews, and six queued performed-voice/music reviews. It creates no character model, monograph, specialist, arc/era synthesis, or full-series synthesis. Native 2034/2053 grouping, release chronology, diegetic time, and analytical reading order stay separate.
...
The **next candidate within the authorized EPISODE 1.0 continuation** is episode `201000601`, opening chapter layer `300070`, ギャル・ライク・イット・ホット, with episode title ライオンの試練 / 第1話. Its catalog metadata identifies the boundary, but its story content has not been opened. The next reading must recheck current authority, source binding, the complete B0006 entering horizon, and any prospective prerequisite before admission. If an unadmitted dependency becomes load-bearing, pause and record a boundary correction; authorization does not extend outside EPISODE 1.0.
