...
source_boundary: "c20260909-r484; complete 235-document 2034 Main horizon plus first 50 non-Main i-n-g episodes / T7S_B0080–T7S_B0104 are reconstructed and integrated; remaining 2034 non-Main stays routed; 2053 and crossover semantics remain gated"
...
major_story_structures:
  T7S_STACK_2034:
    ...
    current_semantic_horizon: "through complete EPISODE NANASUTA / T7S_B0079 plus first 25 complete i-n-g chapters / T7S_B0080–T7S_B0104"
...
**B0104 is closed; the authorized B0100–B0159 run is active (5/60 blocks).** The [run record](09%20Audits%20and%20Manifests/T7S_B0100_B0159_EXECUTION_RECORD.md) binds the 174-episode plan and exact checkpoint. [B0104](02%20Readings/T7S_B0104_DEEP_READING.md): Rona and Musubi read Kazumi’s misplaced novel without consent, then receive an authored, limited opening: Kazumi may continue the story and joins a meal conversation about idol work, while the original privacy breach remains. Performed audio remains unauditioned; the 2034 era release is incomplete and every 2053 semantic operation remains blocked.
