...
source_boundary: "c20260909-r484; through T7S_B0007 / episode 201000601 / primary pages 0–72; later chapter 300070 episodes remain unconsumed"
...
The opening of chapter layer `300070` / ギャル・ライク・イット・ホット is closed as `T7S_B0007`. Its admitted scope is exactly episode `201000601`, script `scout_006_01_01.json__6128561e1329882d`, primary pages/logs `0–72`: 73 pages, 69 text records, four command-only pages, no choice group, and no inline child document. The canonical reading is [T7S_B0007_DEEP_READING.md](../02%20Readings/T7S_B0007_DEEP_READING.md). It treats Sumire's `フツーでイマドキ` self-description as a socially specific identity whose pleasure and unexplained weight coexist, distinguishes her urgent intervention from both a carefree script and the Player's totalizing “kind” label, and records the inversion by which she first treats the searching manager as someone needing help. It also preserves Connie's improvised lion explanation as false provenance but a functional transfer of scouting responsibility.

The **next candidate within the owner-authorized EPISODE 1.0 continuation** is episode `201000602`, script `scout_006_01_02.json__8d81e4f06fd7a7ed`, title ヒトカラ？フタカラ？ / 第2話 前編, in the same chapter layer `300070`. Only its catalog metadata identifies this boundary; its story document has not been opened. Continue only after the B0007 transaction is validated and recoverably published; any source outside EPISODE 1.0 requires separate authorization.

The EPISODE 1.0 frontier is exact and hole-free for 47 episodes: `{201000001, 201000101–201000109, 201000201–201000209, 201000301–201000309, 201000401–201000409, 201000501–201000509, 201000601}`. Within that set all 2,255 primary pages/logs and 2,134 text records are consumed, and all six choice-bearing episodes retain both authored branches. The remaining 44 EPISODE 1.0 memberships, beginning with `201000602`, remain `NOT_STARTED`. Every other 2034 family and every 2053 season/Roots. line remains `NOT_STARTED`; Sub/Event/additional and supplemental obligations remain wholly unscreened. The exact coverage ledger, not a numeric high-water alone, is authoritative for holes. Prequels, NANASUTA, and later-era crossings still require prospective dependency review. An unknown chronology remains unknown; resolve it only when a claim or reading boundary depends on it.

At event level, B0001 retains the recorded last-live `BEFORE` 2034 office edge. B0002 adds an explicitly recounted prior-idol interval before Haru's present arrival plus causal and recontextualizing edges inside her recruitment arc. Complete B0003 adds a causal chain from public persona through coerced exposure, voluntary training, disclosed desire, public test, friendship-based consent, and an unresolved privacy breach; its later account recontextualizes rather than overwrites the opening state. B0004 adds the prior Nicole-imitation scaffold, present recruitment by misrecognition, public confrontation, relational repair, chosen return, reciprocal debut, and immediate error-triggered relapse; later repair recontextualizes rather than erases imitation's earlier benefit or continuing fragility. B0005 adds Hime's childhood/present plurality, shop and household labor, grief disclosure, private agreed rehearsal, material burden-sharing, public entry, debut, and costume-boundary coda; later consent never overwrites earlier refusal or force. B0006 adds Momoka's selective-interest baseline, repeated stage/band/audition entries and exits, explicit coercive capture, deliberately planted media, prepared return, successful stream, formal fifth-performer admission, and immediate lesson-resistance counterexample. B0007 adds Sumire's private pleasure/weight tension, Connie's unplanned withdrawal from the scouting task, the Player's failed independent search, Sumire's mistaken-crisis intervention, and the Player's still-private candidate judgment; her act recontextualizes but does not invalidate the opening self-description. Native sequential consumption is not silently converted into a complete diegetic timeline, and no cross-family ordering or exact calendar date is added. All typed event edges are owned by the story ledger.
