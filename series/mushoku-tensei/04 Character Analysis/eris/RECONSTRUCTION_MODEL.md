...
# Eris: learning, particular loyalties and a growing peer world
...
| --- | --- | --- |
| `MT-EM-ST01` | V02 early household pupil; status security, hostility to imposed tutoring, strong physical response, differentiated task aptitude. | S012; V02:002–008. Do not give her backstage knowledge of staged kidnapping or all adult motives. |
...
## Conditional rules and possible falsifiers

Evidence labels such as V04:016 refer to the canonical observations linked by the index. Rules use D0 DIRECT support for observed choices and only D1 NEAR_ANALOG for bounded reconstruction. No numerical probability or guaranteed output is assigned.
...
Ghislaine is a prior mentor whose authority and protection matter independently of Rudeus. He is a teacher and companion she values, but his account repeatedly misreads her; the model must preserve her refusals and other interests rather than fit his preferred romance script. Ruijerd supplies training and adult competence, with a style that can work for her while failing for Rudeus. Minitoona and Tersena create a peer setting in which she becomes a teacher. Geese is a desired source of cooking instruction who can refuse her without provoking an immediate blow.

Ordinary evidence includes enjoyment of food and excursions, continued sword practice, practical camp adaptation, sadness at selling the mount, curiosity about places, language learning and boredom when others fill every camp role. These constrain plausible low-stakes interactions. They do not establish universal domestic skill, a modern-school persona, comprehensive political knowledge or a reason for every aggressive action.

## Calibration and exclusions

| Test | Contrast and result | Remaining debt |
| --- | --- | --- |
| `MT-EM-V01` task contrast | Patient practice and dance transfer versus uneven literacy/magic;001 requires task-specific supports. | Retrospective; no unseen task prediction. |
| `MT-EM-V02` loyalty/force | V03 excessive retaliation versus V04 tearful nonviolent mentor defense and moderated friend fight;002 permits neither always-violent nor generally-nonviolent output. | Relation/context mechanisms only partly verbalized. |
| `MT-EM-V03` agency contrast | Dependence and excessive faith versus useful market advice, chosen gift and peer teaching;003/004 cannot make her merely obedient. | New peer setting has limited replication. |
| `MT-EM-V04` boundary constraint | Affection and limited permission coexist with stopping an unwanted act;005 rejects consent inferred from attachment. | No generated sexualized test; future practice unknown. |
| `MT-EM-V05` ordinary inconvenience | Requests cooking instruction, receives refusal and does not hit;001/002/006 must tolerate frustration without mandatory aggression. | One request; do not infer universal deference to men or teachers. |

Reject outputs in which every choice serves Rudeus, all anger is defensive justice, every setback causes violence, skill growth means consent, or a missing inner monologue licenses certainty about motive. The model's central uncertainty is how much observed restraint transfers beyond valued relationships. A new non-graphic practical disagreement can test this only after its source is admitted; no outcome is registered here.
