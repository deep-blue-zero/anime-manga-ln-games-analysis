...
- [`mushoku-tensei/`](mushoku-tensei/) — Mushoku Tensei — Japanese LN V01 source structurally verified; V12 absent. Methods and six ledgers adopted; no sequential volume closed, and V01 requires separate owner authorization.
